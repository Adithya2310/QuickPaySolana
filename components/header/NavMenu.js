    ...
    return (
        <nav className="flex flex-1 items-center justify-center">
            <ul className="flex flex-col space-y-10">
                ...
                <li>
                <WalletMultiButton className=' phantom-button' startIcon={<UserCircleIcon style={{  color: '#15ec3c' }} />}>
                    <span className=' font-semibold text-[#15ec3c] text-sm'>{connected? publicKey.toString().substring(0,10):"Connect user"}</span>
                </WalletMultiButton>
                </li>
            </ul>
        </nav >
